  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-12 sm:py-16">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        ...
        <button type="button" onClick={() => onNavigate('/tools/gerador-de-senhas')} className="group rounded-2xl border border-zinc-200 bg-white p-5 text-left transition-colors hover:border-emerald-500/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 dark:border-zinc-800 dark:bg-zinc-900/60">
          <div className="flex items-start justify-between gap-4">
          ...
          <span className="mt-4 inline-block font-mono text-[11px] text-emerald-500">/tools/gerador-de-senhas</span>
        </button>
      </div>
    </main>
  );
